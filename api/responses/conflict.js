...
module.exports = function serverError(data, options) {
    ...
    if (data !== undefined) {
        sails.log.error('Sending 409 ("Conflict") response: \n', data);
    } else
        sails.log.error('Sending empty 409 ("Conflict") response');
    ...
    // but fall back to sending JSON(P) if any errors occur.
        ...
        return res.view('409', {data: viewData, title: 'Conflict'}, function (err, html) {
